...
Polish the already-built deck CRUD views (list, detail, not-found) to match the established design system, now that research confirmed all needed primitives exist.

- Apply design direction to deck list and detail views [up-next] (role: designer)
- Review deck builder UI against design system and existing CRUD wiring [up-next] (role: reviewer)
  - depends on: 9a979162-0a3f-4b29-a870-538a8b313b4c
